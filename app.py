...
class NexusEliteSystem:
    def __init__(self):
        # Initializing secure connection with verified API URL
        self.supabase: Client = create_client(
            st.secrets["SUPABASE_URL"], 
            st.secrets["SUPABASE_KEY"]
        )
        # Strategic Nodes for visual impact
            ...
            if st.button("AUTHORIZE ACCESS"):
                try:
                    if mode == "Register Organization":
                        ...
                        st.success("✅ Registration Request Sent. Confirm in Supabase or Email.")
                    else:
                    ...
                    st.error("Access Denied. Ensure your email is verified or toggle 'Confirm Email' OFF.")
